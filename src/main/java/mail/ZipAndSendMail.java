...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "ramkumar9489@gmail.com"};
	static String fromUser = "ramkumar9489@yahoo.com";// imap on, other devices on, no recovery phone
	static String password = "Emirates@2024";
